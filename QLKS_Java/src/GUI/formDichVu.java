...
public class formDichVu extends javax.swing.JFrame {
    ...
    Statement st= null;
        ...
        public ArrayList<formDichVu> layDanhSachDichVu() {
        ArrayList<formDichVu> dsdv = new ArrayList<formDichVu>();
        ...
        try {
            ...
            formDichVu dv;
            while (rs.next()) {
                dv = new formDichVu(rs.getString("MADV"), rs.getString("TENDV"), rs.getDouble("GIADV") );
    ...
    public void hienThiDanhSachDichVu() {
        ...
        ArrayList<formDichVu> dsdv = layDanhSachDichVu();
