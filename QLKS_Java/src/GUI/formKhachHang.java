...
public class formKhachHang extends javax.swing.JFrame {
    ...
    Statement st=null;
     ...
     public ArrayList<formKhachHang> layDanhSachKhachHang() {
        ArrayList<formKhachHang> dskh = new ArrayList<formKhachHang>();
        ...
        try {
            ...
            formKhachHang kh;
            while (rs.next()) {
                kh = new formKhachHang(rs.getString("MAKH"), rs.getString("TENKH"), rs.getString("CMND"), rs.getString("QUOCTICH"), rs.getString("GIOITINH"), rs.getInt("TUOI"), rs.getString("SDT"), rs.getString("MAPHONG") );
     ...
     public void hienThiDanhSachKhachHang() {
        ...
        ArrayList<formKhachHang> dskh = layDanhSachKhachHang();
